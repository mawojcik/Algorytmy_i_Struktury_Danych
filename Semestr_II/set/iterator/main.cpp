...
int main()
{
    ...
    std::cout << "\n\n\n\n\nZadanie Iterator:" << std::endl;
    std::cout << "Elementy zbioru A wypisane korzystając z iteratora:" << std::endl;
    while (!it.IsDone())
    {
        std::cout << *it << " ";
        ++it;
    ...
    std::cout << "Elementy zbioru B wypisane korzystając z iteratora:" << std::endl;
    while (!it2.IsDone())
    {
        std::cout << *it2 << " ";
        ++it2;
